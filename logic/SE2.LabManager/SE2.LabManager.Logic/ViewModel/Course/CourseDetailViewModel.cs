    ...
    public class CourseDetailViewModel : BaseViewModel {
        ...
        public void UpdateCourse() {
            try {
                ...
                InputFeedback = $"Der Kurs konnte nicht aktualisiert werden. Bitte überprüfen Sie die Eingaben.";
                InputFeedbackPopup();
            }
        }
        ...
        public void CreateLab() {
            try {
                ...
                InputFeedback = $"Das Labor konnte nicht erstellt werden. Bitte überprüfen Sie die Eingaben.";
                InputFeedbackPopup();
